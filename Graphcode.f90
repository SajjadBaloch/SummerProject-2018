...
!--------------------------------------------------------------------------------------------------
	...
	call Accelerations(y,a,r,v,z)
		
	! Set the RHS vector f
	f(1:N3)  = y(1+N3:)	! Velocities
	f(1+N3:) = a			! Accelerations
	
end subroutine RHS

!--------------------------------------------------------------------------------------------------
subroutine Accelerations(y,a,r,v,z)
!--------------------------------------------------------------------------------------------------
...
!--------------------------------------------------------------------------------------------------
	...
	real*8 :: X										! Dummy variable
	
	X=1d0+z
	H=H0*SQRT(OmL+(OmM/X+Omk)/X/X)	
...
!--------------------------------------------------------------------------------------------------
	...
	real*8,external :: H			! Hubble parameter
	
	dz = -(1d0+z)*H(z)*dt		! Change in redshift
