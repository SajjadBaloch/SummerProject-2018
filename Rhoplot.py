...
for i in xrange(N):
	ax.plot(t,delta[i],color=colors[i],marker='.',ms=s,lw=0.5,ls='none')
...
plt.ylabel(r'$\delta = \frac{\rho}{\bar{\rho}}$',size=txt)
...
ax.legend(handles=[pos_mass,neg_mass],bbox_to_anchor=(0.,1.,1.,.075),loc=2,borderaxespad=0.,fontsize=0.8*txt,frameon=True)
